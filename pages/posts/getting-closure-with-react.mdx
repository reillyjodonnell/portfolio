...
tag: react, typescript, javascript, react
author: You
---
...
This is because \[state behaves like a snapshot\]([https://react.dev/learn/state-as-a-snapshot](https://react.dev/learn/state-as-a-snapshot))
